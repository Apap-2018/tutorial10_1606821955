...
import { FormTambahHasilLabPasien } from '../containers/FormTambahHasilLabPasien';
import { Appointment } from '../utils/Appointment';

export class TambahHasilLabPasien extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            loading: true,
    ...
    render() {
        if (this.state.loading) {
            ...
            return (
                <FormTambahHasilLabPasien pasien={this.state.pasien} onSubmit={this.handleFormSubmit} />
            )
        }
    }
}